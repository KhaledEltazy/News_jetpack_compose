...
import com.android.news.presentation.common.SearchBar
...
fun SearchScreen(
    ...
    Column(
        modifier = Modifier.padding(top = MediumPadding1, start = MediumPadding1, end = MediumPadding1).statusBarsPadding()
    ) {
        SearchBar(
